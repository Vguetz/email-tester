...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-zinc-950 flex flex-col items-center justify-center overflow-hidden selection:bg-zinc-800">
      <div className="absolute top-[-20%] left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-zinc-600/20 blur-[120px] rounded-full pointer-events-none" />
      ...
      >
        ...
        <motion.div variants={itemVariants}>
          <h1 className="text-5xl md:text-7xl font-bold tracking-tighter text-zinc-100 mb-6">
            Rayos X para tus <br />
            <span className="text-zinc-500">correos electrónicos.</span>
          </h1>
        </motion.div>

        <motion.div variants={itemVariants}>
          <p className="text-base md:text-lg text-zinc-400 mb-10 max-w-xl mx-auto font-light leading-relaxed">
            El primer linter visual que te muestra en tiempo real cómo Outlook y
            Gmail van a destruir tu código, para que puedas arreglarlo antes de
            enviarlo.
          </p>
        </motion.div>
